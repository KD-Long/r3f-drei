# [R3F-Drei](https://r3f-drei.kyledlong.com)
...
```bash
git clone https://github.com/KD-Long/r3f-drei.git
```
...
4. Automatic deployment --> ~/public_html/_sub_r3f-drei/

5. Configured sub domain [r3f-drei.kyledlong.com](https://r3f-drei.kyledlong.com) to point to "_sub_r3f-drei/" folder